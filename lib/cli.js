...
module.exports = async () => {
  ...
  // console.log(require('cra-template-fregata-react-lib/package.json'))
  ...
  program
    ...
    .option('-e, --example <Yes|No|y|n>', 'install example')
    .option(
      '-s, --skip-prompts',
  ...
  const opts = {
    name: `crl_${Math.random().toString('16').slice(2)}`,
    ...
    templatePath: program.templatePath || 'cra-template-fregata-react-lib',
